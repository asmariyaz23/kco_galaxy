...
bsub -q regevlab -P pacbio -e $PIPERRFILE -o $PIPEOUTFILE -R "rusage[mem=10]" -K python /seq/regev_genome_portal/SOFTWARE/galaxy/tools/SMRT_analysis_LSF/launch_library.py --lib_summary $LIBSUMMARY --loci_rarefaction $LOCIRAREFACTION --junctions_rarefaction $JUNCTIONSRAREFACTION --lib_table $LIBRARY --out_path $OUTPUTDIR
